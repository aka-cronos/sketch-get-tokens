...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/get-text-tokens.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var textStyles = doc.sharedTextStyles;

  if (!textStyles.length) {
    sketch__WEBPACK_IMPORTED_MODULE_1___default.a.UI.alert('No Text Styles', 'There are no text styles!');
  } else {
    var formattedTokens = textStyles.reduce(function (prev, textStyle) {
    ...
    savePanel.runModal();
    var file = NSString.stringWithString(JSON.stringify(formattedTokens, null, 2));
    var filePath = savePanel.URL().path();
    file.writeToFile_atomically_encoding_error(filePath, true, NSUTF8StringEncoding, null);
    sketch__WEBPACK_IMPORTED_MODULE_1___default.a.UI.alert('Text Styles exported', 'Text styles exported succesfully!');
  }
});
...
//# sourceMappingURL=__get-text-tokens.js.map